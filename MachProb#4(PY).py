...
print("")
h1 = float(input('Please input the initial height: '))
print("")
v1 = float(input('Please input the initial velocity: '))
print("")
angle = float(input('Please input the angle in degrees: '))
print("")
ax = float(input('Please input acceleration in the x direction: '))
print("")
ay1 = float(input('Please input acceleration in the y direction: '))
